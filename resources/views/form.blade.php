...
<div class="fixed inset-0 overflow-hidden pointer-events-none z-0">
    {{-- Top-right soft blob --}}
    <div style="position:absolute;top:-120px;right:-120px;width:480px;height:480px;border-radius:50%;background:radial-gradient(circle,rgba(123,47,190,0.12) 0%,transparent 70%);"></div>
    {{-- Bottom-left soft blob --}}
    <div style="position:absolute;bottom:-80px;left:-80px;width:360px;height:360px;border-radius:50%;background:radial-gradient(circle,rgba(201,168,76,0.1) 0%,transparent 70%);"></div>
    {{-- Subtle grid pattern --}}
    <div style="position:absolute;inset:0;background-image:radial-gradient(circle,rgba(75,0,130,0.04) 1px,transparent 1px);background-size:32px 32px;"></div>
</div>
...
<div class="relative z-10 min-h-screen py-10 px-4 flex flex-col items-center justify-start">
    ...
    <header class="w-full max-w-2xl mb-10 fade-in">
        ...
        <div class="text-center">
            <div class="inline-flex items-center gap-2 mb-4 px-4 py-2 rounded-full border text-xs font-semibold tracking-wider uppercase"
                ...
                <span style="width:6px;height:6px;border-radius:50%;background:#C9A84C;display:inline-block;animation:pulse 1.5s infinite;"></span>
                Soulwinning Campaign 2.0
            </div>

            <h1 class="font-display font-black text-4xl md:text-5xl leading-tight mb-3"
                style="color:#2D0050;">
                10 Souls
                <span style="background:linear-gradient(135deg,#C9A84C,#F0C040);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">
                    in 10 Days
                </span>
            </h1>
    ...
    <div class="w-full max-w-2xl fade-in delay-1">
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden"
            ...
            {{-- Card top accent bar --}}
            <div class="h-1.5 w-full" style="background:linear-gradient(90deg,#2D0050,#7B2FBE,#C9A84C,#F0C040,#C9A84C);"></div>
            ...
            <div class="p-8 md:p-10">
                ...
                <form action="{{ route('register.store') }}" method="POST" class="space-y-5">
                    ...
                    <div class="fade-in delay-2">
                        ...
                        <div class="input-wrapper">
                            ...
                            <select name="title" class="input-field" style="padding-left:48px;" required>
                                <option value="" disabled {{ old('title') ? '' : 'selected' }}>Select your title</option>
                                @foreach(['Pastor','Brother','Sister','Deacon','Deaconess'] as $t)
                                    <option value="{{ $t }}" {{ old('title') == $t ? 'selected' : '' }}>{{ $t }}</option>
                                @endforeach
                            </select>
                            {{-- Custom chevron for select --}}
                            <svg class="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 pointer-events-none" style="color:#7B2FBE;" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="fade-in delay-4">
                        <label class="block text-sm font-semibold mb-2" style="color:#2D0050;">
                            Church <span class="text-red-400">*</span>
                        </label>
                        <div class="input-wrapper">
                            <svg class="input-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                            ...
                            <input type="text" name="church" class="input-field"
                                   placeholder="e.g. CE Victoria Island"
                    ...
                    <div class="fade-in delay-4">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="group" class="input-field"
                                   placeholder="e.g. Zone 5 Group A"
                        ...
                        <div class="p-5 rounded-2xl border-2 border-dashed"
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <button type="button" id="decrement"
                                        class="w-11 h-11 rounded-xl flex items-center justify-center font-bold text-xl transition-all"
                                        style="background:rgba(75,0,130,0.08);color:#4B0082;"
                                        onclick="changeCount(-1)">−</button>

                                <div class="flex-1 text-center">
                                    <div class="font-display font-black text-5xl" style="background:linear-gradient(135deg,#C9A84C,#F0C040);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;" id="count-display">1</div>
                                    <p class="text-xs text-gray-400 mt-1 font-medium tracking-wide uppercase">souls committed</p>
                                </div>
                            ...
                            <input type="hidden" name="souls_commitment" id="souls_input" value="{{ old('souls_commitment', 1) }}"/>
                        </div>
                    </div>
                    ...
                    <div class="pt-4 fade-in delay-6">
                        ...
                        <p class="text-center text-xs text-gray-400 mt-4">
                            ...
                            the <span class="font-semibold" style="color:#4B0082;">10 Souls in 10 Days</span> campaign.
                        </p>
                    </div>
                </form>
            </div>
        ...
        {{-- Footer links --}}
        <div class="mt-8 text-center text-xs text-gray-400 space-y-2 fade-in delay-6">
            <p>
                Register at:
                <a href="https://kingsforms.online/10soulsin10daysapril"
                   class="font-semibold hover:underline" style="color:#7B2FBE;">
                    kingsforms.online/10soulsin10daysapril
                </a>
            </p>
            <p>
                Submit souls data:
                <a href="https://kingsforms.online/10soulsin10daysdata"
                   class="font-semibold hover:underline" style="color:#7B2FBE;">
                    kingsforms.online/10soulsin10daysdata
                </a>
            </p>
        </div>
    </div>
